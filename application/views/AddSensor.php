...
<div class="allcontain">
	<div class="feturedsection">
		<h1 class="text-center"><span class="bdots"></span>Add Sensor<span class="carstxt"></span></h1>
	</div>
<div class="container">
  <div class="container">
  	<hr>
	<div class="row">
      ...
      <!-- edit form column -->
        ...
        <form method="post" action="<?php echo base_url(); ?>index.php/devices/addSensor" class="form-horizontal" role="form">
